...
| --- | --- | --- | --- | --- |
| P0 | [AR-0040](tasks/AR-0040.md): Reusable discussion TUI architecture and navigation | Create the reusable two-pane discussion TUI in the AWG product. | Release AR-0040 after merged PR and Coordinator reconciliation; select the next ready TUI AR. | codex-ar0040-discussion-tui-20260917 |
...
| P0 | [AR-0038](tasks/AR-0038.md): Post-discussion reconciliation and reopen loop | Reconcile user guidance into versioned plans, designs, specifications, and ARs. | Release AR-0038 after merged PR and Coordinator reconciliation; select and promote AR-0039. | - |
