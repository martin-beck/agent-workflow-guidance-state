...
| --- | --- | --- | --- | --- |
| P1 | [AR-0032](tasks/AR-0032.md): Formal-spec migration batch two | codex-ar0032-migration-batch2-20260917 | Migrate the second formal-decision AR batch. | Migrate AR-0006 through AR-0010 with explicit specification and formal-check references. |
