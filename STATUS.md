...
| --- | --- | --- | --- | --- |
| P1 | [AR-0005](tasks/AR-0005.md): Clarification and expected-regret gate | codex-ar0005-clarification-gate-20260917 | Model when an agent should clarify instead of acting. | Translate clarification-question and expected-regret literature into an AWG gate and fixtures. |
