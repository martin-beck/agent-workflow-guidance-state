...
| --- | --- | --- | --- | --- |
| P0 | [AR-0028](tasks/AR-0028.md): Self-hosting AWG evolution workflow | codex-ar0028-self-hosting-20260917 | Make Agent Workflow Guidance self-hosting and govern its own evolution. | Apply the AWG workflow to AWG&#x27;s own future design, implementation, quality, and coordination changes after the initial formal gates are complete. |
