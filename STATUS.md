...
| --- | --- | --- | --- | --- |
| P1 | [AR-0006](tasks/AR-0006.md): Uncertainty-aware assistance and calibration | codex-ar0006-calibration-20260917 | Transfer uncertainty-aware assistance into software-task guidance. | Define separate calibration measures for applicability, outcome, and downstream-impact confidence. |
